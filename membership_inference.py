...
def load_attack_model():
    local_path = '/home/nkama/train_and_test_error/models/attack_model.pth'
...
def membership_inference():
    ...
    target_model_path = "/home/nkama/train_and_test_error/models/weights_resnet18_cifar10.pth"
